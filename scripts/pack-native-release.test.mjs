...
import {
  RUNTIME_TREE_FIXTURE_SEQUENCE,
  createRuntimeTreeFixture
} from "./runtime-tree-fixture.mjs";
...
test(
  ...
  () => {
    ...
    try {
      ...
      assert.ok(
        manifest.archives.every(
          (archive) => archive.runtimeSequence === RUNTIME_TREE_FIXTURE_SEQUENCE
        )
      );
    } finally {

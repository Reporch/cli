...
assert.match(runtimeRelease, /RUNTIME_SEQUENCE: "20"/);
...
assert.match(runtimeRelease, /RUNTIME_TAG: reporch-runtime-v1-seq20/);
assert.match(
  runtimeCandidates,

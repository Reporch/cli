...
assert.match(runtimeRelease, /RUNTIME_SEQUENCE: "21"/);
...
assert.match(runtimeRelease, /RUNTIME_TAG: reporch-runtime-v1-seq21/);
assert.match(
  runtimeCandidates,

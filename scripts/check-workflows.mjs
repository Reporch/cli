...
assert.match(runtimeRelease, /RUNTIME_SEQUENCE: "19"/);
...
assert.match(runtimeRelease, /RUNTIME_TAG: reporch-runtime-v1-seq19/);
assert.match(
  runtimeCandidates,

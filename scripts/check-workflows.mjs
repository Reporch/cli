...
assert.match(runtimeRelease, /RUNTIME_SEQUENCE: "22"/);
...
assert.match(runtimeRelease, /RUNTIME_TAG: reporch-runtime-v1-seq22/);
assert.match(
  runtimeCandidates,
